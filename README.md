...
├── bloom_filter.py # Pipeline phát hiện trùng lặp y hệt bằng Bloom Filter
...
├── embeddings_ver2.txt # File lưu vector embedding (dạng text)
├── embeddings_ver2.json # File lưu vector embedding (dạng JSON)
...
└── README.md # (File bạn đang đọc nè ❤️)
